...
const NewSchemaPage = () => {
  ...
  return (
    <>
      ...
      <Form
        form={form}
        onFinishFailed={(evt) => console.log(evt)}
        onFinish={saveSchema}
      >
        <Form.Item label="Title" name="title" rules={[{ required: true }]}>
          <Input name="title" onChange={handleChangeSchema} />
        </Form.Item>
        <Form.Item
          name="description"
          label="Description"
          rules={[{ required: true }]}
        >
          <Input name="description" onChange={handleChangeSchema} />
        </Form.Item>
        ...
        {Object.keys(properties).map((prop) => (
          <Property key={prop} propName={prop} />
        ))}
        <AddProperty
